...
\supervisor{Esp. Ing. Eric Pernia (UNQ, FIUBA)} % El nombre del director, se usa en la carátula y se puede usar el cualquier lugar del documento con el comando \supname
...
mediante un lenguaje gráfico y se utiliza como una herramienta para la
educación.
